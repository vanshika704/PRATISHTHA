...
class CategoriesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: Text("Categories"), titleTextStyle: GoogleFonts.lexend(color: Color.fromARGB(255, 4, 19, 33), fontSize: 20), backgroundColor: Color.fromARGB(255, 48, 115, 173),),
      body: Align(
